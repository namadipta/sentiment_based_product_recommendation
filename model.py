...
count_vector = pk.load(open('pkl_files/count_vector.pkl','rb'))            # Count Vectorizer
tfidf_transformer = pk.load(open('pkl_files/tfidf_transformer.pkl','rb')) # TFIDF Transformer
model = pk.load(open('pkl_files/model.pkl','rb'))                          # Classification Model
recommend_matrix = pk.load(open('pkl_files/user_final_rating.pkl','rb'))   # User-User Recommendation System 
...
def recommend_products(user_name):
    recommend_matrix = pk.load(open('pkl_files/user_final_rating.pkl','rb'))
